...
function Navbar() {
    ...
    return (
        <div className="z-999 relative min-h-[10%] borde border-(--border)/60 shadow-(--shadow-sm)  flex justify-between items-center px-5">
            ...
            <Link href="/recordings" className={`${pathname.includes('recordings') && 'bg-(--bg-secondary)'} tracking-wider flex items-center gap-3 py-2 px-5`}><LuAudioWaveform /> Recordings</Link>
