...
function Navbar() {
    ...
    return (
        <div className="z-999 relative bg-(--layer) h-[10%] shadow flex justify-between items-center px-5">
            ...
            <div className={`${!isMenu ? '-translate-y-5 pointer-events-none opacity-0':'opacity-100 pointer-events-auto translate-0'} duration-300 ease-in-out transition-all bg-(--layer) absolute p-5 border-t border-amber-950 shadow-lg h-50 w-full left-0 top-full flex flex-col gap-2`}>
