      ...
      <div className="w-full hover:bg-(--card-hover) duration-300 ease-in-out transition-all hover:cursor-pointer" onClick={() => setIsExpand(!isExpand)}>
        <div className="w-full grid grid-cols-9 lg:grid-cols-12 px-3 py-3 border-b border-(--border)">
          ...
          <p className=" col-span-2 lg:col-span-4 text-[0.60rem] lg:text-sm text-left hyphens-auto">
            {el.studentName.split(' ').length > 2 && el.studentName.split(' ').slice(1,el.studentName.split(' ').length).join(' ')}
          ...
          <p className=" col-span-2 lg:col-span-4 text-[0.60rem] lg:text-sm text-left truncate">
            {el.teacherName.split(' ').length > 2 && el.teacherName.split(' ').slice(1,el.teacherName.split(' ').length).join(' ')}
